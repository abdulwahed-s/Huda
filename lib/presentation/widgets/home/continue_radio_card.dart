...
class ContinueRadioCard extends StatelessWidget {
  final bool hasLastStation;
  ...
  const ContinueRadioCard({
    super.key,
    required this.hasLastStation,
    this.onTap,
  ...
  Widget build(BuildContext context) {
    ...
    final foregroundColor =
        hasLastStation ? Colors.white : const Color(0xFF1F2937);
    final secondaryColor = hasLastStation
      ...
      child: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: hasLastStation ? activeGradient : inactiveGradient,
          ),
          border: Border.all(
              ...
              children: [
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Icon(
                      hasLastStation ? Icons.radio : Icons.history,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        hasLastStation ? continueText : noActivityText,
                        maxLines: 2,
