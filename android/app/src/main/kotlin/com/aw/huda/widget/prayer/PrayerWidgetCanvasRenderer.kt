...
internal object PrayerWidgetCanvasRenderer {
    ...
    private class Drawing(
        ...
        private fun drawAtmosphere() {
            ...
            val accentCenterX = if (state.design == PrayerWidgetDesign.HERO) width * 0.78f else width * 0.12f
            val accentCenterY = if (state.design == PrayerWidgetDesign.HERO) height * 0.30f else height * 0.04f
            val atmosphereAlpha = if (palette.transparent) 0.08f else if (palette.isLight) 0.16f else 0.24f
            ...
            canvas.drawRect(bounds, Paint(Paint.ANTI_ALIAS_FLAG).apply {
                shader = RadialGradient(
                    ...
                    PrayerWidgetPaletteResolver.withAlpha(palette.gold, if (palette.transparent) 0.05f else 0.15f),
                    Color.TRANSPARENT,
                    Shader.TileMode.CLAMP,
                )
            })
        ...
        private fun drawGeometry() {
            ...
            if (state.design == PrayerWidgetDesign.HERO) {
                ...
                val horizon = Path().apply {
                    ...
                    cubicTo(width * 0.24f, height * 0.54f, width * 0.67f, height * 0.56f, width * 1.08f, height * 0.78f)
                }
        ...
        private fun drawSpotlightOneByOne() {
            ...
            text(next.name.uppercase(locale()), 8f, frame.y(31f), widthDp - 16f, frame.h(12f), 9.5f, palette.text, medium, Align.CENTER)
            formattedNumericText(next.formattedTime, 7f, frame.y(46f), widthDp - 14f, frame.h(22f), 20f, palette.text, Align.CENTER)
        ...
        private fun drawSpotlightWidth() {
            ...
            label(PrayerWidgetLocalization.string("next_prayer", state.locale), contentStart, frame.y(20f), prayerWidth, frame.h(10f), 7f)
            text(next.name, contentStart, frame.y(33f), prayerWidth, frame.h(18f), 15f, palette.text, bold, Align.START)
            formattedNumericText(next.formattedTime, contentStart, frame.y(53f), prayerWidth, frame.h(23f), 17f, palette.text, Align.START)
            label(PrayerWidgetLocalization.string("remaining", state.locale), countdownX, frame.y(25f), countdownWidth, frame.h(10f), 6.5f, Align.END)
            countdownText(
                state.countdown,
                countdownX,
                frame.y(39f),
        ...
        private fun drawSpotlightNarrowWidth(
            ...
            label(
                PrayerWidgetLocalization.string("next_prayer", state.locale),
                contentX,
                frame.y(23f),
                primaryWidth,
                frame.h(10f),
            ...
            label(
                PrayerWidgetLocalization.string("remaining", state.locale),
                countdownX,
                frame.y(27f),
                countdownWidth,
                frame.h(10f),
        ...
        private fun drawSpotlightSmall() {
            ...
            label(PrayerWidgetLocalization.string("next_prayer", state.locale), 12f, frame.y(39f), widthDp - 24f, frame.h(13f), 8f)
            text(next.name, 12f, frame.y(51f), widthDp - 24f, frame.h(28f), 22f, palette.text, headlineTypeface(), Align.START)
            formattedNumericText(next.formattedTime, 12f, frame.y(78f), widthDp - 24f, frame.h(32f), 27f, palette.text, Align.START)
            ...
            state.afterNext?.let { after ->
                ...
                text(after.name, 29f, frame.y(148f), widthDp * 0.44f, frame.h(16f), 9f, palette.secondary, medium, Align.START)
                formattedNumericText(after.formattedTime, widthDp * 0.61f, frame.y(148f), widthDp * 0.31f, frame.h(16f), 9f, palette.secondary, Align.END)
            }
        }
        ...
        private fun drawSpotlightMedium() {
            ...
            label(PrayerWidgetLocalization.string("next_prayer", state.locale), 14f, frame.y(43f), dividerX - 28f, frame.h(13f), 8f)
            text(next.name, 14f, frame.y(55f), dividerX - 28f, frame.h(31f), 25f, palette.text, headlineTypeface(), Align.START)
            formattedNumericText(next.formattedTime, 14f, frame.y(84f), dividerX - 28f, frame.h(37f), 29f, palette.text, Align.START)
            ...
            rows.forEachIndexed { index, item ->
                drawTimelineRow(
                    ...
                    when (item.kind) {
                        state.current?.kind -> PrayerWidgetLocalization.string("current", state.locale)
                        state.next.kind -> PrayerWidgetLocalization.string("next_prayer", state.locale)
                        else -> null
                    },
                )
        ...
        private fun drawSpotlightLarge() {
            ...
            label(PrayerWidgetLocalization.string("next_prayer", state.locale), 16f, frame.y(59f), widthDp * 0.55f, frame.h(15f), 9f)
            text(next.name, 16f, frame.y(73f), widthDp * 0.60f, frame.h(45f), 36f, palette.text, headlineTypeface(), Align.START)
            formattedNumericText(next.formattedTime, 16f, frame.y(115f), widthDp * 0.62f, frame.h(46f), 35f, palette.text, Align.START)
            ...
            label(PrayerWidgetLocalization.string("schedule", state.locale), 16f, frame.y(214f), widthDp - 32f, frame.h(11f), 8f)
            val gap = 8f
        ...
        private fun drawAlmanacOneByOne() {
            ...
            label(state.weekday, 9f, frame.y(13f), widthDp * 0.45f, frame.h(13f), 7f, Align.START, palette.gold)
            text(state.dateBadge, widthDp - 35f, frame.y(10f), 27f, frame.h(18f), 16f, palette.text, amiriBold, Align.END)
            line(9f, frame.y(31f), widthDp - 9f, frame.y(31f), palette.gold, 0.34f)
            drawPhaseDot(next.kind, 9f, frame.y(39f), 9f, true)
            text(next.name, 22f, frame.y(36f), widthDp - 30f, frame.h(23f), 12f, palette.text, amiriBold, Align.START)
            formattedNumericText(next.formattedTime, 8f, frame.y(60f), widthDp - 16f, frame.h(27f), 18f, palette.text, Align.START)
        }
        ...
        private fun drawAlmanacWidth() {
            ...
            label(state.weekday, 13f, frame.y(22f), 42f, frame.h(11f), 7f, Align.CENTER, palette.gold)
            text(state.dateBadge, 13f, frame.y(34f), 42f, frame.h(34f), 27f, palette.text, amiriBold, Align.CENTER)
            line(64f, frame.y(18f), 64f, frame.y(78f), palette.gold, 0.34f)
            label(PrayerWidgetLocalization.string("next_prayer", state.locale), contentX, frame.y(20f), prayerWidth, frame.h(10f), 7f)
            text(next.name, contentX, frame.y(33f), prayerWidth, frame.h(18f), 14.5f, palette.text, amiriBold, Align.START)
            formattedNumericText(next.formattedTime, contentX, frame.y(53f), prayerWidth, frame.h(23f), 15.5f, palette.text, Align.START)
            label(PrayerWidgetLocalization.string("remaining", state.locale), countdownX, frame.y(25f), countdownWidth, frame.h(10f), 6.5f, Align.END)
            countdownText(
                state.countdown,
                countdownX,
        ...
        private fun drawAlmanacLarge() {
            ...
            label(PrayerWidgetLocalization.string("prayer_table", state.locale), 16f, frame.y(166f), widthDp - 32f, frame.h(12f), 8f)
            val gap = 7f
            ...
            line(16f, frame.y(nightY - 11f), widthDp - 16f, frame.y(nightY - 11f), palette.gold, 0.24f)
            val nightGap = 10f
        ...
        private fun drawSpotlightHeader(x: Float, y: Float, compact: Boolean, maxWidth: Float = widthDp - x * 2f) {
            ...
            state.current?.let { current ->
                ...
                text(
                    "${current.name.uppercase(locale())} · ${PrayerWidgetLocalization.string("current", state.locale).uppercase(locale())}",
                    px + 5f,
                    y + 1f,
                    pillWidth - 10f,
                    mark - 2f,
        ...
        private fun drawDateHeader(x: Float, y: Float, compact: Boolean) {
            ...
            label(state.weekday, x, y, dateW, if (compact) 11f else 13f, if (compact) 7f else 9f, Align.CENTER, palette.gold)
            text(state.dateBadge, x, y + if (compact) 10f else 13f, dateW, if (compact) 29f else 42f, if (compact) 21f else 34f, palette.text, amiriBold, Align.CENTER)
            ...
            if (current != null) {
                text(
                    "${current.name} · ${PrayerWidgetLocalization.string("current", state.locale).uppercase(locale())}",
                    infoX,
            ...
            drawHudaMark(widthDp - x - if (compact) 18f else 22f, y + if (compact) 7f else 13f, if (compact) 18f else 22f)
        }

        private fun drawCountdownBand(x: Float, y: Float, w: Float, h: Float, compact: Boolean) {
            pill(x, y, w, h, palette.accent, if (palette.isLight) 0.12f else 0.11f, if (compact) 12f else 16f, strokeAlpha = 0.25f)
            if (compact && w < 132f) {
        ...
        private fun drawNextBand(x: Float, y: Float, w: Float, h: Float, compact: Boolean) {
            val next = state.next ?: return
            pill(x, y, w, h, palette.accent, if (palette.isLight) 0.11f else 0.10f, if (compact) 10f else 14f, strokeAlpha = 0.22f)
            ...
            val nextValue = if (compact && w < 190f) next.name else "${next.name}  ${next.formattedTime}"
            label(PrayerWidgetLocalization.string("next_prayer", state.locale), infoX, y + if (compact) 4f else 7f, w * 0.42f, if (compact) 11f else 13f, if (compact) 6.4f else 8f)
            text(nextValue, infoX, y + if (compact) 15f else 21f, infoWidth, h - if (compact) 17f else 24f, if (compact) 11f else 17f, palette.text, amiriBold, Align.START)
            ...
            label(PrayerWidgetLocalization.string("remaining", state.locale), countdownX, blockTop, countdownWidth, labelHeight, if (compact) 5.7f else 7f, Align.END)
            countdownText(
                state.countdown,
                countdownX,
        ...
        private fun drawTimelineRow(item: PrayerWidgetRenderItem, x: Float, y: Float, w: Float, h: Float, highlighted: Boolean, stateLabel: String?) {
            ...
            text(item.name, contentX, y + 4f, nameWidth, if (stateLabel == null) h - 8f else 14f, if (narrow) 9.5f else 10f, if (highlighted) palette.text else palette.secondary, if (highlighted) bold else medium, Align.START)
            if (stateLabel != null) label(stateLabel, contentX, y + 17f, nameWidth, 9f, 5.8f, Align.START, if (highlighted) palette.accent else palette.secondary)
            formattedNumericText(item.formattedTime, timeX, y + 5f, timeWidth, h - 10f, 9f, if (highlighted) palette.accent else palette.secondary, Align.END)
        }
        ...
        private fun drawScheduleCell(
            ...
            pill(x, y, w, h, background, if (highlighted) 0.11f else if (palette.isLight) 0.04f else 0.05f, if (compact) 8f else 11f)
            if (inline) {
                val dot = 10f
                val nameX = x + 20f
            ...
            if (prominent) {
                ...
                text(item.name, nameX, y, nameWidth, h, 11f, if (highlighted) palette.text else palette.secondary, if (highlighted) bold else medium, Align.START)
                formattedNumericText(item.formattedTime, timeX, y, timeWidth, h, 11.5f, if (highlighted) palette.accent else palette.text, Align.END)
                return
            }
            text(item.name, x + if (compact) 19f else 24f, y + if (compact) 3f else 6f, w - if (compact) 24f else 30f, if (compact) 14f else 19f, if (compact) 7.5f else 10.5f, if (highlighted) palette.text else if (item.kind == PrayerKind.SUNRISE) palette.gold else palette.secondary, if (highlighted) bold else medium, Align.START)
            formattedNumericText(item.formattedTime, x + if (compact) 7f else 9f, y + if (compact) 16f else 27f, w - if (compact) 14f else 18f, if (compact) 14f else 20f, if (compact) 8.5f else 12.5f, if (highlighted) palette.accent else palette.text, Align.START)
        }

        private fun drawRuleRow(item: PrayerWidgetRenderItem, x: Float, y: Float, w: Float, h: Float, highlighted: Boolean) {
            drawPhaseDot(item.kind, x, y + 4f, 9f, highlighted)
            text(item.name, x + 14f, y, w * 0.56f, h, 8.5f, if (highlighted) palette.accent else palette.secondary, if (highlighted) bold else medium, Align.START)
            formattedNumericText(item.formattedTime, x + w * 0.66f, y, w * 0.34f, h, 8.5f, if (highlighted) palette.accent else palette.text, Align.END)
        }
        ...
        private fun drawNightCell(
            ...
            formattedNumericText(time, x + 38f, y + 20f, w - 44f, 20f, 12f, palette.text, Align.START)
        }
        ...
        private fun drawEmpty() {
            ...
            if (tiny) {
                ...
                numericText("--:--", 8f, heightDp * 0.48f, widthDp - 16f, 24f, 17f, palette.text, Align.CENTER)
                return
            }
            drawHudaMark(widthDp / 2f - 17f, heightDp * 0.18f, 34f)
            val message = PrayerWidgetLocalization.string("empty_message", state.locale)
            multiline(message, 18f, heightDp * 0.45f, widthDp - 36f, heightDp * 0.38f, if (family == WidgetFamily.LARGE) 15f else 12f, palette.text, medium, 3)
        }

        private fun drawEmergency() {
            drawHudaMark(widthDp / 2f - min(widthDp, heightDp) * 0.18f, heightDp / 2f - min(widthDp, heightDp) * 0.18f, min(widthDp, heightDp) * 0.36f)
        }
        ...
        private fun drawHudaMark(x: Float, y: Float, diameter: Float) {
            ...
            circlePx(rect.centerX(), rect.centerY(), radius, PrayerWidgetPaletteResolver.withAlpha(palette.accent, 0.12f))
            canvas.drawCircle(rect.centerX(), rect.centerY(), radius - dp(0.4f), Paint(Paint.ANTI_ALIAS_FLAG).apply {
                style = Paint.Style.STROKE
        ...
        private fun drawPhaseDot(kind: PrayerKind, x: Float, y: Float, diameter: Float, highlighted: Boolean, physical: Boolean = false) {
            val color = if (highlighted) palette.accent else if (kind == PrayerKind.SUNRISE) palette.gold else palette.secondary
            drawLegacyPrayerIcon(kind, x, y, diameter, color, physical)
        }

        private fun drawCelestial(kind: PrayerKind, x: Float, y: Float, diameter: Float, physical: Boolean = false) {
            drawLegacyPrayerIcon(kind, x, y, diameter, palette.gold, physical, insetFraction = 0.08f)
        }
        ...
        private fun drawLegacyPrayerIcon(
            ...
            val rect = if (physical) RectF(dp(x), dp(y), dp(x + diameter), dp(y + diameter)) else logicalRect(x, y, diameter, diameter)
        ...
        private fun countdownText(
            ...
            val target = state.next?.time?.time ?: return
            if (countdownOverlay == null && resolvedSize > 0f && target > state.now.time) {
        ...
        private fun label(text: String, x: Float, y: Float, w: Float, h: Float, size: Float, align: Align = Align.START, color: Int = palette.secondary) {
            this.text(text.uppercase(locale()), x, y, w, h, size, color, medium, align, letterSpacing = 0.09f)
        }
        ...
        private fun text(
            ...
            while (!fits() && size > floor) size = (size - 0.4f).coerceAtLeast(floor)
            paint.textSize = dp(size)
            val rendered = TextUtils.ellipsize(value, android.text.TextPaint(paint), rect.width(), TextUtils.TruncateAt.END).toString()
        ...
        private fun multiline(value: String, x: Float, y: Float, w: Float, h: Float, baseSize: Float, color: Int, typeface: Typeface, maxLines: Int) {
            val rect = logicalRect(x, y, w, h)
            ...
            do {
                ...
                layout = StaticLayout.Builder.obtain(value, 0, value.length, paint, rect.width().roundToInt().coerceAtLeast(1))
            ...
            canvas.save()
            canvas.translate(rect.left, rect.top + ((rect.height() - layout.height) / 2f).coerceAtLeast(0f))
            layout.draw(canvas)
            canvas.restore()
        }

        private fun pill(x: Float, y: Float, w: Float, h: Float, color: Int, alpha: Float, radius: Float, strokeAlpha: Float = 0f) {
            val rect = logicalRect(x, y, w, h)
        ...
        private fun line(x1: Float, y1: Float, x2: Float, y2: Float, color: Int, alpha: Float) {
            ...
            canvas.drawLine(start.first, start.second, end.first, end.second, Paint(Paint.ANTI_ALIAS_FLAG).apply {
                strokeWidth = dp(0.8f)
                this.color = PrayerWidgetPaletteResolver.withAlpha(color, alpha)
            })
        }
